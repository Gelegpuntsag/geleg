...
public class EditProductActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnzahial1= (Button) findViewById(R.id.btnzahial1);
		...
		btnzahial1.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View view) {
				// Launching All products Activity
				Intent i = new Intent(getApplicationContext(), zahialga.class);
				startActivity(i);
